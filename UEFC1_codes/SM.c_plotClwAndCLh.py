...
plt.plot(alpha_e_deg, CLw, color='red', linewidth=2, label=r"$C_{Lw}$")
plt.plot(alpha_e_deg, CLh, color='blue', linewidth=2, label=r"$C_{Lh}$")
...
plt.title(r"SM5(c): $C_{Lw}$ and $C_{Lh}$ vs. $\alpha_e$ for Plane Vanilla")
plt.grid(True)
plt.legend()
plt.tight_layout()
plt.show()
